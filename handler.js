...
export async function handler(chatUpdate) {
  ...
  try {
      ...
      if ((usedPrefix = (match[0] || "")[0])) {
        ...
        if (
          ...
          if (m.text && user.banned && !isROwner) {
            ...
            m.reply(
              `🚫 إنت محظور، مش هتقدر تستخدم أوامر البوت ده!\n\n${
                user.bannedReason
                  ? `\n💌 *المُسبب:* 
    ${user.bannedReason}`
                  : "💌 *المُسبب:* مش محدد"
              }\n\n⚠️ *لو البوت ده هو الحساب الرسمي وعندك دليل يثبت إن الرسالة دي خطأ، ممكن تعرض حالتك هنا:*\n\n🤍 ${asistencia}`,
            );
            user.antispam++;
            return;
          }
          ...
          if (new Date() - global.db.data.users[m.sender].spam < 3000)
            return console.log(`[ رسائل مزعجة ]`);
        ...
        if (
          ...
          conn.reply(m.chat, `نفدت منك *💴 المال*`, m, fake);
          continue;
        }
        let extra = {
          match,
    ...
    if (db.data.chats[m.chat].reaction && m.text.match(/(بوت|شادو|س|ا)/gi)) {
      let emot = pickRandom([
        "🌸",
        "😃",
        "😄",
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner:
      "「🌟」 *الوظيفة دي بس للمطور بتاعي يا بطل، مش لحد غيره* 💥\n\n> Eslam Elshnawy.",
    owner: "「🌟」 *الوظيفة دي بس للمطور بتاعي، ما فيش حد تاني* 💥",
    mods: "「🌟」 *الوظيفة دي بس للمطورين بتوعي، دول بتوعي* 💥",
    premium: "「🌟」 *الوظيفة دي للمستخدمين بريميوم بس، لو مش بريميوم معلش* 💥",
    group: "「🌟」 *الوظيفة دي تشتغل بس في الجروبات، مفيش شات خاص هنا* 💥",
    private: "「🌟」 *الوظيفة دي تشتغل بس في الشات الخاص، مش في الجروبات* 💥",
    admin: "「🌟」 *الأمر ده تقدر تستخدمه بس لو أنت أدمن في الجروب* 💥",
    botAdmin: "「🌟」 *عشان تستخدم الوظيفة دي، لازم أكون أدمن في الجروب* 💥",
    unreg:
      "「🌟」 *هيه! مش مسجل، سجل عشان تستخدم الوظيفة دي يا بطل* 💥\n\n*.تسجيل الاسم.السن*\n\n*مثال* : *.تسجيل اسلام.17* 💥",
    restrict: "「🌟」 *الخاصية دي متوقفة حاليًا، استنى شوية* 💥",
  }[type];
