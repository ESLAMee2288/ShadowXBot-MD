...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let { exp, money, level, role } = global.db.data.users[m.sender];
    ...
    const pp = await conn
      ...
      .catch((_) => "https://i.ibb.co/rQnbMPF/img6.jpg");
      ...
      m.chat,
      {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: "ЅℋᎯⅅᎾᏇ X ℬᎾT",
            serverMessageId: -1,
          },
          forwardingScore: 999,
          externalAdReply: {
            title: "Eslam Elshnawy",
            body: dev,
            thumbnailUrl: icono,
            sourceUrl: redes,
            mediaType: 1,
    ...
    await m.react(error);
    conn.reply(m.chat, "「✘」 *حدث خطأ أثناء إرسال القائمة*", m, rcanal);
    throw e;
  }
};
handler.help = ["menu"];
